...
def update_rover(Rover, data):
    '''
        your RoverState() object gets updated with each new batch of telemetry
    '''
...
def create_output_images(Rover):
    """
        Rover.worldmap is compared with the ground truth map and gets converted, along with Rover.vision_image, into base64 strings to send back to the rover.
    """
